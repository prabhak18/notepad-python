...
class MyNotepad:
    ...
    def __init__(self,master):
        ...
        master.bind("<control-O>,self.open_file")
        self.txt_area=Text(master,padx=5,pady=5,wrap=WORD,selectbackground="green",bd=2,insertwidth=7,undo=True)
...
######################################################################################################
        ...
        self.edit_menu.add_command(label="Redu",command=self.txt_area.edit_redo)
        self.edit_menu.add_separator()
        ...
        self.color_menu.add_command(label="Fore ground Color", command=self.change_forecolor)
